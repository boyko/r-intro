...
[R-studio](https://www.rstudio.com/) is an integrated development environment (IDE) build specially for R. While not strictly necessary for working with R files it makes
