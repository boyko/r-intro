...
On Windows right-click on your desktop to open the context menu. From that menu choose git bash. This will open a console window with a command prompt. On the command line enter (replace Your Name with your actual name but keep the quotation marks! and replace your@email.com with the email you used when you registered with Github).
~~~
...
On Linux/Mac open a shell and enter the lines above.

To check that you have configured `git` properly enter
~~~
git config --list
~~~
